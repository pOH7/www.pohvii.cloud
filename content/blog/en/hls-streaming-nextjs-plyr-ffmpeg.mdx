...
If you run into mobile fullscreen quirks, the
[Video.js HTML5 tech docs](https://docs.videojs.com/tech_html5.js.html)
outline the platform-specific hooks and events you can reuse to keep controls
reliable on iOS and Android. For production QA, this
[ffprobe-driven quality checklist](https://gist.github.com/io-st/9aabbac93ef7d32f1312c763495f10fb)
walks through validating bitrate ladders, caption tracks, and manifest health
before you ship new encodes.
