...
const IMGPROXY_BASE_URL =
  process.env.IMGPROXY_BASE_URL || "https://images.pohvii.cloud";
...
#### Enable CORS for Image Components
...
_For more details on implementing Imgproxy with Next.js, check out the [official Imgproxy blog post](https://imgproxy.net/blog/image-optimization-for-nextjs-with-imgproxy/)._
